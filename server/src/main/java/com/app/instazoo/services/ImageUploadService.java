...
import com.app.instazoo.exceptions.ImageNotFoundException;
...
/**
 * Декомпрессор и компрессор написаны Rida Shaikh
...
public class ImageUploadService {
    ...
    // decompress the image bytes bofore returning it to the angular application
    ...
    /**
     * Method helper to return one and only Post from User
     */
